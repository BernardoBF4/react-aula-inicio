...
export { FirstStep, List, Books, ShowOff, Button }; // As I am exporting two elements, I need to put them into an object, what will make necessary for me to destructure them when importing them on index.js
